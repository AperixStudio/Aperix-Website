...
// Reference snapshot of the current design — preserved for comparison.
// Build your new look at / (page.tsx) and compare here at /current.
export default function CurrentDesign() {
  return (
    <>
      <AgencyNavV2 />
      <HeroV4 />
      ...
      <main id="main-content">
        <h1 className="sr-only">Aperix Studio — Custom Web Development and Software Solutions Melbourne</h1>
        <script
